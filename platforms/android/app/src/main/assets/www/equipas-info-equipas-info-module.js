...
var EquipasInfoPage = /** @class */ (function () {
    function EquipasInfoPage(route, InfoService) {
        this.route = route;
    ...
    EquipasInfoPage.prototype.getCurrentInfo = function () {
        ...
        this.InfoService.getInfoTeams(this.id).subscribe(function (infoteam) { return _this.info = infoteam; });
    };
    ...
    EquipasInfoPage.prototype.onNumberError = function (event) {
        console.log(event);
        event.target = "?";
    };
