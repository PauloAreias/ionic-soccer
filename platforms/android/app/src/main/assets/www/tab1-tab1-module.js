...
var Tab1Page = /** @class */ (function () {
    function Tab1Page(ligaService, menuCtrl, AlertController, navCtrl) {
    ...
    Tab1Page.prototype.getCurrentLiga = function (liga) {
        var _this = this;
        this.ligaService.getCurrentLiga(liga).subscribe(function (response) { _this.ligas = response; }, function (error) {
            _this.onIonError();
        });
    };
    Tab1Page.prototype.getCurrentStandings = function (Liga) {
        var _this = this;
        this.ligaService.getCurrentStandings(Liga).subscribe(function (response) { _this.standings = response; }, function (error) {
            _this.onIonError();
        });
    };
    Tab1Page.prototype.closeMenu = function () {
        this.menuCtrl.close();
    };
    Tab1Page.prototype.onIonError = function () {
