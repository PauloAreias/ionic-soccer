...
import { HostListener, Directive, ElementRef, Injectable, Inject, defineInjectable, inject, Optional, Component, ChangeDetectionStrategy, ChangeDetectorRef, InjectionToken, NgZone, ApplicationRef, Injector, ViewContainerRef, ComponentFactoryResolver, Attribute, SkipSelf, Output, EventEmitter, ViewChild, ContentChild, TemplateRef, IterableDiffers, APP_INITIALIZER, NgModule } from '@angular/core';
        ...
        if (win) {
            ...
            function () {
                return defineCustomElements(win, {
                     ...
                     * @return {?}
                     */
                    function (h) { return (win.__zone_symbol__requestAnimationFrame) ? win.__zone_symbol__requestAnimationFrame(h) : requestAnimationFrame(h); }),
                    ael: /**
                     * @param {?} elm
                     * @param {?} eventName
                     * @param {?} cb
                    ...
                    function (elm, eventName, cb, opts) {
                        if (((/** @type {?} */ (elm))).__zone_symbol__addEventListener && skipZone(eventName)) {
                            ((/** @type {?} */ (elm))).__zone_symbol__addEventListener(eventName, cb, opts);
                        }
                        else {
                     ...
                     */
                    function (elm, eventName, cb, opts) {
                        if (((/** @type {?} */ (elm))).__zone_symbol__removeEventListener && skipZone(eventName)) {
                            ((/** @type {?} */ (elm))).__zone_symbol__removeEventListener(eventName, cb, opts);
                        }
                        else {
